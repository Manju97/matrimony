...
function giveMeAge(str){
	
	if(str!="")
	{
	var yearSave=str.substring(0,4);
	//alert(yearSave);
	var d = new Date();
var n = d.getFullYear();
...
var s=n-yearSave;
//alert(s);
var ageText=document.getElementById('takeYourAge');
ageText.value=s;
	//alert(yearSave);
	}
	else
                ...
                <div class="container">
                    <div class="row">
                            	...
                            	<div class="row">
                                	...
                                	<div class="col-xs-12 col-sm-2 col-md-2 dashboard-nav">
                                    	...
                                    	<li><a href="register_details.php"><span><i class="fa fa-dashboard"></i></span>Home</a></li>
                                        	...
                                        	<li><a href="viewprofile.php"><span><i class="fa fa-heart"></i></span>Find your Soulmate</a></li>
						...
						?>
                                		...
                                		<h2 class="dash-content-title"><span class="entry--meta-cat" style='font-size:20px'><a href="#"><font size='5'><?php echo $row_1[1]." ".$row_1[2]; ?></font></a> , <a href="#"><font size='3'><?php echo $row_1[7]; ?></font></a></span></h2>
                                            ...
                                            <div class="panel-body">
                                            	...
                                            	<div class="row">
                                                    ...
                                                    <div class="col-sm-3 col-md-4  user-detail">
														...
														<span>File:</span><input type='file' value='<?php echo $row_1[11]; ?>' class="form-control" name="file">
														 
														 
				                                         <input type='hidden' name='f_name' value='<?php echo $row_1[1];?>'>
                                                         
														 <input type='hidden' name='l_name' value='<?php echo $row_1[2];?>'>
														 <input type='hidden' name='id' value='<?php echo $row_1[0];?>'>

                                                          
														   
														   <li><span>Date of Birth:</span><?php echo $date; ?><input type='date' name='dob' value='<?php echo $date; ?>' style="width:250px; height:35px" class="form-control"></li>
                                                           
														   <li><span>Age:</span><input type='text' name='age' value='<?php echo $row_1[6]; ?>' style="width:250px; height:35px" class="form-control"></li>
                                                            
															<li><span>Gender:</span><select name='gender'   style="width:250px; height:35px" class="form-control">
								                          <option value="<?php echo $row_1['gender'] ?>"> <?php echo $row_1['gender'] ?>  </option>
								                           <option value='Male'> Male </option>
								                          <option value='Female'> Female </option></select></li>
														  
                                                            <li><span>Religion:</span><input type='text' name='religion' value='<?php echo $row_1[8]; ?>' style="width:250px; height:35px" class="form-control"></li>                    
                                                             <li><span>Education:</span><select name='education'   style="width:250px; height:35px" class="form-control">
								               <option value="<?php echo $row_1['education'] ;?>"> </option>
							                  <option value="select">select</option>
							                   ...
							                   <li><span>Job:</span><select name='job'   style="width:250px; height:35px" class="form-control">
										       <option value="<?php echo $row_1['job']; ?>">  </option>
												 <option value="Select">Select</option>
															...
															<li><span>Email:</span><input type='text' name="email" value='<?php echo $row_1['email']; ?>' style="width:250px; height:35px" class="form-control"></li>
                                                            <li><span>Phone:</span><input type='text' name="phone" value='<?php echo $row_1['phone']; ?>' style="width:250px; height:35px" class="form-control"></li>
                                                            <li><span>Address:</span><input type='textarea' name='address' value='<?php echo $row_1['address']; ?>' style="width:250px; height:35px" class="form-control"></li>
                                                           <li><span>Siblings</span><input type='text' name='siblings' value='<?php echo $row_1['siblings']; ?>' style="width:250px; height:35px" class="form-control"></li>
                                                        </ul>
                                                        
                                                   	</div>
													<div class="col-sm-3 col-md-4  user-detail">
                                                        <ul class="list-unstyled">
                                                            <li><span>Father name:</span><input type='text' name='father_name' value='<?php echo $row_1['father_name']; ?>' style="width:250px; height:35px" class="form-control"></li>
                                                            
															<li><span>Mother name::</span><input type='text' name='mother_name' value='<?php echo $row_1['mother_name']; ?>' style="width:250px; height:35px" class="form-control"></li>
                                                           
                                                            <li><span>Height:</span><input type='text' name='height' value='<?php echo $row_1['height']; ?>' style="width:250px; height:35px" class="form-control"></li>                                                       
                                                            <li><span>Birth Time:</span><input type='text' name='b_time' value='<?php echo $row_1['b_time']; ?>' style="width:250px; height:35px" class="form-control"></li>
                                                           
														   <li><span>Color:</span><input type='text' name='color' value='<?php echo $row_1['color']; ?>' style="width:250px; height:35px" class="form-control"></li>
															
                                                            <li><span>Zodiac Sign:</span><select name='rashi'   style="width:250px; height:35px" class="form-control">
										<option value="<?php echo $row_1['rashi'] ?>">  </option>
															 <option value="select">select</option>
                                        <option value="mesha(aries)">Mesha(Aries)</option>
							                   ...
							                   <option value="meena(pisces)">Meena(Pisces)</option>
                                                           ...
                                                           <li><span>Birth-Star:</span>
														   <select name='nakshatra'   style="width:250px; height:35px" class="form-control">
										<option value="">  </option>
										                        <option value="select">select</option>
							                   ...
							                   <option value="revathi">Revathi</option>
                                                            ...
                                                            <li><span>God:</span><input type='text' name='god' value="<?php echo $row_1['god']; ?>" style="width:250px; height:35px" class="form-control"></li>
															
                                                            <li><span>Expectations:</span><input type='text' name='expectations' value='<?php echo $row_1['expectations']; ?>' style="width:250px; height:35px" class="form-control"></li>
															
                                                            <li><span>Region:</span><select name='region'   style="width:250px; height:35px" class="form-control">
								                               <option value="<?php echo $row_1['region'] ?>"> 
															
								                          <option value="South karnataka"> South Karnataka </option>
								                          <option value="North karnataka"> North Karnataka </option></select></li>
															
															
                                                        </ul>
														<input type='hidden' name='inc_id' value='<?php echo $row_1[0];?>'><button class='btn btn-details' name="submit" id="submit" class="form-submit" style="background-color:#5cb85c">Update </button>
                                                        </form>
                                                   	</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
		...
		<div class="form-group">
		  ...
		  <div class="form-group">
            <label for="recipient-name" class="control-label">Rashi</label><br>
             <Select class="form-control" style="height: 35px" placeholder="Rashi" name="rashi"  id="rashi" />
																		 <option value="select">select</option>
                                        <option value="mesha(aries)">Mesha(Aries)</option>
							                   <option value="vrushabha(taurus)">Vrushabha(Taurus)</option>
							                   <option value="mithuna(gemini)">Mithuna(Gemini)</option>
		  ...
		  <div class="form-group">
            <label for="recipient-name" class="control-label">Nakshatra</label><br>
             <select class="form-control"  style="height: 35px" placeholder="Nakshatra" name="nakshatra"  id="nakshatra" />
			    <option value="select">select</option>
                                                <option value="ashwini">Ashwini</option>
							                    <option value="bharani">Bharani</option>
							                   <option value="krutthika">Krutthika</option>					                 
      ...
      <div class="modal-footer">
	  	  <button type="submit" class="btn btn-orange" onclick="submit()">Submit</button>
		  </form>
