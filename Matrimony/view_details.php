                    ...
                    <div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        	<div class="dashboard-heading">
                                <h2 style='font-size:24px'>Thank you, &nbsp <span> for registering with us</span></h2>
                                              ...
                                              <div class="panel-body">
                                            	...
                                            	<div class="row">
                                                	...
                                                	<div class="col-sm-5 col-md-4 user-img">
                                                        <img src="uploads/<?php echo $row_1[11]; ?>" class="img-responsive" alt="user-img" / style='height:220px;width:230px'>
                                                    </div><!-- end columns -->
                                                    ...
                                                    <div class="col-sm-3 col-md-4  user-detail">
                                                        <ul class="list-unstyled">
                                                           ...
                                                           <li><span>Expectations</span> <?php echo $row_1[25]?></li>
                                                        </ul>
                                                        
                                                   	</div>
													<div class="col-sm-3 col-md-4  user-detail">
                                                        <ul class="list-unstyled">
                                                            <li><span>Father Name:</span> <?php echo $row_1[14]?></li>
                                                            <li><span>Mother Name:</span> <?php echo $row_1[15]?></li> 
                                                            <li><span>Siblings:</span> <?php echo $row_1[16]?></li> 
															<li><span>Height:</span> <?php echo $row_1[17]?></li> 
                                                            <li><span>Birth Time:</span> <?php echo $row_1[18]?></li>
                                                            <li><span>Color:</span><?php echo $row_1[19]?></li>
                                                            <li><span>Rashi:</span><?php echo $row_1[21]?></li>
                                                            <li><span>Nakshatra:</span> <?php echo $row_1[22]?></li>
                                                            <li><span>God:</span> <?php echo $row_1[23]?></li> 
															<li><span>Region:</span> <?php echo $row_1[26]?></li>
    ...
    <div class="modal-content">
	  ...
	  <div class="form-group">
		...
		<div class="form-group">
		  ...
		  <div class="form-group">
            <label for="recipient-name" >Nakshatra</label><br>
